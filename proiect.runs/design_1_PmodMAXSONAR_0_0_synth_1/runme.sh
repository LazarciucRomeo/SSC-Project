...
HD_PWD='D:/UTC/AN3/SEM1/SSC/Proiect/proiect/proiect.runs/design_1_PmodMAXSONAR_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodMAXSONAR_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodMAXSONAR_0_0.tcl
